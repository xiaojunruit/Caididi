...
//        if (attrs != null) {
//            TypedArray a = getContext().obtainStyledAttributes(attrs, cn.gavinliu.android.lib.shapedimageview.R.styleable.ShapedImageView);
        mShapeMode = SHAPE_MODE_ROUND_RECT;
        mRadius = Device.dp2px(3);
//            a.recycle();
//        }
        mPaint = new Paint();
    ...
    public void setShapeMode(int mShapeMode) {
