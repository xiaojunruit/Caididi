...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
    ...
    String st1;
    private FrameLayout voiceContronlLayout;
...
//        }
        ...
        voiceContronlLayout = (FrameLayout) findViewById(R.id.ll_voice_control);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_handsfree:
                if (isHandsfreeState) {
                    handsFreeImage.setImageResource(R.mipmap.ic_hands_free_un);
                    closeSpeakerOn();
                    isHandsfreeState = false;
                } else {
                    handsFreeImage.setImageResource(R.mipmap.ic_hands_free_su);
                    openSpeakerOn();
