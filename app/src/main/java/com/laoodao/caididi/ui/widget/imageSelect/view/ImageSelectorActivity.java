package com.laoodao.caididi.ui.widget.imageSelect.view;
...
import com.laoodao.caididi.ui.widget.imageSelect.adapter.ImageFolderAdapter;
import com.laoodao.caididi.ui.widget.imageSelect.adapter.ImageListAdapter;
import com.laoodao.caididi.ui.widget.imageSelect.model.LocalMedia;
import com.laoodao.caididi.ui.widget.imageSelect.model.LocalMediaFolder;
import com.laoodao.caididi.ui.widget.imageSelect.utils.FileUtils;
import com.laoodao.caididi.ui.widget.imageSelect.utils.GridSpacingItemDecoration;
import com.laoodao.caididi.ui.widget.imageSelect.utils.LocalMediaLoader;
import com.laoodao.caididi.ui.widget.imageSelect.utils.ScreenUtils;
...
public class ImageSelectorActivity extends BaseActivity {
    ...
    public void registerListener() {
        ...
        imageAdapter.setOnImageSelectChangedListener(new ImageListAdapter.OnImageSelectChangedListener() {
            ...
            public void onChange(List<LocalMedia> selectImages) {
                ...
                if (enable) {
                    ...
                    previewText.setText("预览(" + selectImages.size() + ")");
                } else {
                    doneText.setText("完成");
        ...
        doneText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onSelectDone((ArrayList<LocalMedia>) imageAdapter.getSelectedImages());
            }
        });
    ...
    public void startPreview(List<LocalMedia> previewImages, int position) {
        ImagePreviewActivity.startPreview(this, previewImages, imageAdapter.getSelectedImages(), maxSelectNum, position,false);
    }
     ...
     * @param medias
     */
    public void onSelectDone(ArrayList<LocalMedia> medias) {
    ...
    public void onResult(ArrayList<LocalMedia> images) {
        setResult(RESULT_OK, new Intent().putExtra(REQUEST_OUTPUT, images));
        finish();
    }
}
