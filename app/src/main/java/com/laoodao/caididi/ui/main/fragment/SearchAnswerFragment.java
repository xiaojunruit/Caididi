...
public class SearchAnswerFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    private String keyword;
    private BaseAdapter adapter = new ItemAdapter(SearchHolder.class);
