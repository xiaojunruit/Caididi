...
import com.laoodao.caididi.ui.my.holder.MesReplyHolder;
...
public class ReplyFragment extends ListFragment{
    ...
    protected BaseAdapter onCreateAdapter() {
        return new ItemAdapter<>(MesReplyHolder.class);
    }
    ...
    protected void onPage(int page) {
        API.user().readMes(MessageActivity.REPLY,page).compose(transform()).subscribe(this::onPageLoaded);
    }
}
