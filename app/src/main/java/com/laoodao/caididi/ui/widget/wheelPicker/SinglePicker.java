...
/**
 */
public class SinglePicker<T extends City> extends WheelPicker {
    ...
    public void setSelectedItem(@NonNull T item) {
        setSelectedIndex(itemStrings.indexOf(item.n));
    }
