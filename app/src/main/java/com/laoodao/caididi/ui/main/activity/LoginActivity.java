...
import com.laoodao.caididi.ui.main.fragment.LoginWXFragment;
...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getToolbar().findViewById(R.id.btn_back).setOnClickListener(v -> {

            finish();
        });

        FragmentUtil.add(this, R.id.lyt_login_body, LoginWXFragment.class);
    }
