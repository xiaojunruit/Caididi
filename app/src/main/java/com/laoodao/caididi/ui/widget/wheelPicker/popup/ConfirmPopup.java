package com.laoodao.caididi.ui.widget.wheelPicker.popup;
...
import com.laoodao.caididi.ui.widget.wheelPicker.utils.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    /*public void setCancelBack(int back) {
        if (cancelButton != null) {
            cancelButton.setBackgroundResource(back);
        } else {
            this.back = back;
        }
