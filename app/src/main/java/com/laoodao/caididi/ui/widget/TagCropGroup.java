...
public class TagCropGroup<T> extends ViewGroup {
    ...
    public TagCropGroup(Context context) {
        this(context, null);
    }

    public TagCropGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TagCropGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setList(List<T> tags) {
        ...
        for (int i = 0; i < tags.size(); i++) {
            ...
            if (mTagViewFactory != null) {
                ...
                view = LayoutInflater.from(getContext()).inflate(R.layout.item_crop, null, false);
