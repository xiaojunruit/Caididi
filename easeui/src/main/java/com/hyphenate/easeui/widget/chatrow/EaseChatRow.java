...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private OnSendAvatar mOnSendAvatar;

    public void setOnSendAvatar(OnSendAvatar avatar) {
        mOnSendAvatar = avatar;
    }

    public interface OnSendAvatar {
        void setOnSendAvatar(ImageView imgAvatar, boolean send);
    }
    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                mOnSendAvatar.setOnSendAvatar(userAvatarView, true);
//                EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
            } else {
                mOnSendAvatar.setOnSendAvatar(userAvatarView, false);
