...
public class EaseChatMessageList extends RelativeLayout{
    ...
    public void setAvatar(String avatar, String userAvatar) {
        this.avatar = avatar;
    ...
    public void init(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider) {
        ...
        messageAdapter.setOnSendAvatarAdapter(new EaseMessageAdapter.OnSendAvatarAdapter() {
            @Override
            public void setOnSendAvatarAdapter(ImageView imgAvatar, boolean send) {
                Glide.with(getContext()).load(send ? userAvatar : avatar).diskCacheStrategy(DiskCacheStrategy.SOURCE).into(imgAvatar);
            }
        });
        refreshSelectLast();
    }
