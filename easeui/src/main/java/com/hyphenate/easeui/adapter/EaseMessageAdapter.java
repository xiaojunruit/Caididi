...
public class EaseMessageAdapter extends BaseAdapter{
	...
	private OnSendAvatarAdapter mOnSendAvatarAdapter;

	public void setOnSendAvatarAdapter(OnSendAvatarAdapter avatar) {
		mOnSendAvatarAdapter = avatar;
	}

	public interface OnSendAvatarAdapter {
		void setOnSendAvatarAdapter(ImageView imgAvatar, boolean send);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		((EaseChatRow) convertView).setOnSendAvatar(new EaseChatRow.OnSendAvatar() {
			@Override
			public void setOnSendAvatar(ImageView imgAvatar, boolean send) {
				mOnSendAvatarAdapter.setOnSendAvatarAdapter(imgAvatar,send);
			}
		});
