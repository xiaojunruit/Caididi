...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAvatar = fragmentArgs.getString("avatar");
        mUserAvatar = fragmentArgs.getString("userAvatar");
    ...
    protected void initView() {
        ...
        ivSend = (TextView) getView().findViewById(R.id.tv_send);
        etSendTxt = (EditText) getView().findViewById(R.id.et_send_txt);
        ivVoice = (ImageView) getView().findViewById(R.id.iv_voice);
        ...
        llPic = (LinearLayout) getView().findViewById(R.id.ll_pic);
        llCamera = (LinearLayout) getView().findViewById(R.id.ll_camera);
        ...
        listener();
        messageList.setAvatar(mAvatar, mUserAvatar);
    }
    ...
    private void listener() {
        ...
        llVideo.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (chatFragmentHelper != null) {
                    if (chatFragmentHelper.onExtendMenuItemClick(ITEM_VIDEO_CALL, v)) {
                        return;
                    }
                }
            }
        });
        llVoice.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (chatFragmentHelper != null) {
                    if (chatFragmentHelper.onExtendMenuItemClick(ITEM_VOICE_CALL, v)) {
                        return;
                    }
                }
            }
        ...
        ivVoice.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mRlSendTxt.setVisibility(View.GONE);
        ...
        ivKeyboard.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mRlSendTxt.setVisibility(View.VISIBLE);
        ...
        ivSend.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String content = etSendTxt.getText().toString();
        ...
        tvSendVoice.setOnTouchListener(new OnTouchListener() {
            @Override
...
//                    titleBar.setTitle(group.getGroupName());
    ...
    protected void sendTextMessage(String content) {
        if (EaseAtMessageHelper.get().containsAtUsername(content)) {
            ...
            sendMessage(message);
            chatFragmentHelper.onSendText(content);
        }
    }
    ...
    protected void sendVoiceMessage(String filePath, int length) {
        ...
        sendMessage(message);
        chatFragmentHelper.onSendVoice(filePath);
    }

    protected void sendImageMessage(String imagePath) {
        EMMessage message = EMMessage.createImageSendMessage(imagePath, false, toChatUsername);
        sendMessage(message);
        chatFragmentHelper.onSendImage(imagePath);
    }
    ...
    public interface EaseChatFragmentHelper {
        void onSendVoice(String content);

        void onSendText(String content);

        void onSendImage(String content);
